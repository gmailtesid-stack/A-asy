...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('users.index')); ?>">Pengguna</a></li>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-600">Foto Profil (Opsional)</label>
...
unset($__errorArgs, $__bag); ?>" required id="roleSelect">
                            ...
                            <option value="manager" <?php echo e(old('role') == 'manager' ? 'selected' : ''); ?>>Manager Outlet</option>
                    ...
                    <div class="mb-3" id="outletDiv">
                        ...
                        <select name="outlet_id" class="form-select <?php $__errorArgs = ['outlet_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($outlet->id); ?>" <?php echo e(old('outlet_id') == $outlet->id ? 'selected' : ''); ?>><?php echo e($outlet->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo e(route('users.index')); ?>" class="btn btn-light">Batal</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity\scratch\easy-pos\resources\views\users\create.blade.php ENDPATH**/ ?>