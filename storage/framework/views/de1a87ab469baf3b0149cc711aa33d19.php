<?php $__env->startSection('title', 'Dashboard Real-time - E-ASY WMS & POS'); ?>
...
<div class="animate__animated animate__fadeIn">
    ...
    <div class="row mb-5 align-items-center">
        <div class="col-xl-7 col-lg-6 mb-4 mb-lg-0">
            <h1 class="fw-800 mb-1" style="font-size: 2.5rem; letter-spacing:-1px;">
                Selamat Datang, <span class="text-gradient"><?php echo e(auth()->user()->name); ?></span>
            </h1>
    ...
    <div class="mb-5">
        ...
        <div class="row g-3">
            <?php if(auth()->user()->hasPermission('create-so') || auth()->user()->isSuperAdmin()): ?>
            <div class="col-6 col-md-3 col-xl-2">
                <a href="<?php echo e(route('pos.index')); ?>" class="quick-action-btn">
            ...
            <?php if(auth()->user()->hasPermission('create-po') || auth()->user()->hasPermission('create-grn') || auth()->user()->isSuperAdmin()): ?>
            <div class="col-6 col-md-3 col-xl-2">
                <a href="<?php echo e(route('inbound.create')); ?>" class="quick-action-btn">
            ...
            <?php if(auth()->user()->hasPermission('create-so') || auth()->user()->hasPermission('process-picking') || auth()->user()->isSuperAdmin()): ?>
            <div class="col-6 col-md-3 col-xl-2">
                <a href="<?php echo e(route('outbound.create')); ?>" class="quick-action-btn">
            ...
            <?php if(auth()->user()->hasPermission('view-master-data') || auth()->user()->isSuperAdmin()): ?>
            <div class="col-6 col-md-3 col-xl-2">
                <a href="<?php echo e(route('inventories.index')); ?>" class="quick-action-btn">
            ...
            <?php if(auth()->user()->hasPermission('view-reports') || auth()->user()->isSuperAdmin()): ?>
            <div class="col-6 col-md-3 col-xl-2">
                <a href="<?php echo e(route('reports.index')); ?>" class="quick-action-btn">
            ...
            <div class="col-6 col-md-3 col-xl-2">
                <a href="<?php echo e(route('reports.wms')); ?>" class="quick-action-btn">
    ...
    <div class="row g-4 mb-5">
        <div class="col-xl-3 col-md-6">
            <div class="glass-panel p-4 h-100" style="background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); border: none;">
                ...
                <div class="stat-value text-white">Rp <?php echo e(number_format($stats['total_stock_value'], 0, ',', '.')); ?></div>
                <div class="mt-3 pt-3 border-top border-white border-opacity-10">
                    <div class="d-flex justify-content-between text-white small opacity-75">
                        ...
                        <span class="fw-bold"><?php echo e($stats['oms_live']); ?></span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="glass-panel p-4 h-100">
                ...
                <div class="stat-value text-danger"><?php echo e($stats['low_stock_count']); ?> <span class="fs-6 text-muted fw-normal">Items</span></div>
            ...
            <div class="glass-panel p-4 h-100">
                ...
                <div class="d-flex align-items-center gap-3 mt-2">
                    <div class="text-center">
                        <div class="fw-800 text-dark" style="font-size: 1.2rem;"><?php echo e($stats['oms_draft']); ?></div>
                        <div class="text-muted fs-xs fw-bold">DRAFT</div>
                    </div>
                    <div class="vr opacity-25"></div>
                    <div class="text-center">
                        <div class="fw-800 text-warning" style="font-size: 1.2rem;"><?php echo e($stats['oms_review']); ?></div>
                ...
                <div class="progress mt-3" style="height: 6px; border-radius: 10px; background: rgba(0,0,0,0.05);">
                    ...
                    ?>
                    <div class="progress-bar bg-success" style="width: <?php echo e($pLive); ?>%"></div>
                    <div class="progress-bar bg-secondary" style="width: <?php echo e($pDraft); ?>%"></div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="glass-panel p-4 h-100" style="background: linear-gradient(135deg, #1e293b 0%, #334155 100%); border: none;">
                ...
                <div class="row g-2 mt-2">
                    <div class="col-4 text-center">
                        <div class="fw-800 text-white" style="font-size: 1.1rem;"><?php echo e($stats['pending_so']); ?></div>
                        <div class="text-white text-opacity-50 fs-xs">NEW</div>
                    </div>
                    <div class="col-4 text-center">
                        <div class="fw-800 text-warning" style="font-size: 1.1rem;"><?php echo e($stats['picking_so']); ?></div>
                        <div class="text-white text-opacity-50 fs-xs">PICK</div>
                    </div>
                    <div class="col-4 text-center">
                        <div class="fw-800 text-info" style="font-size: 1.1rem;"><?php echo e($stats['packing_so']); ?></div>
            ...
            <div class="glass-panel h-100 d-flex flex-column p-1">
                <div class="p-4 pb-0 d-flex align-items-center justify-content-between mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <span class="badge bg-primary-subtle text-primary rounded-pill px-3 py-2"><i class="bi bi-shop me-1"></i> <?php echo e(count($outlets)); ?> Outlet</span>
                        <span class="badge bg-success-subtle text-success rounded-pill px-3 py-2"><i class="bi bi-building-fill me-1"></i> <?php echo e(count($warehouses)); ?> Gudang</span>
                    </div>
                </div>
        ...
        <div class="col-xl-4">
            <div class="glass-panel h-100 p-0 d-flex flex-column">
                ...
                <div class="p-0 overflow-auto" style="max-height: 450px;">
                    <div class="list-group list-group-flush">
                        <?php $__empty_1 = true; $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php if(!is_object($activity)): ?> <?php continue; ?> <?php endif; ?>
                        <div class="list-group-item border-0 p-4 bg-transparent position-relative" style="border-bottom: 1px dashed var(--dash-glass-border) !important;">
                            <div class="d-flex align-items-start gap-3">
                                <div class="rounded-circle mt-1 flex-shrink-0" style="width: 12px; height: 12px; background: <?php echo e(($activity->type ?? '') == 'in' ? '#10b981' : (($activity->type ?? '') == 'out' ? '#6366f1' : '#f59e0b')); ?>; box-shadow: 0 0 10px <?php echo e(($activity->type ?? '') == 'in' ? '#10b981' : (($activity->type ?? '') == 'out' ? '#6366f1' : '#f59e0b')); ?>;"></div>
                                <div class="flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        <span class="badge bg-<?php echo e(($activity->type ?? '') == 'in' ? 'success' : (($activity->type ?? '') == 'out' ? 'primary' : 'warning')); ?>-subtle text-<?php echo e(($activity->type ?? '') == 'in' ? 'success' : (($activity->type ?? '') == 'out' ? 'primary' : 'warning')); ?> rounded-pill" style="font-size: 0.65rem; font-weight: 800;"><?php echo e(strtoupper($activity->type ?? 'LOG')); ?></span>
                                        <span class="text-muted" style="font-size: 0.7rem;"><i class="bi bi-clock"></i> <?php echo e(\Carbon\Carbon::parse($activity->created_at ?? now())->diffForHumans()); ?></span>
                                    </div>
                                    <p class="mb-2 small lh-sm">
                                        <span class="fw-800 text-dark"><?php echo e($activity->product_name ?? 'Produk'); ?></span> 
                                        <?php echo e(($activity->type ?? '') == 'in' ? 'bertambah' : (($activity->type ?? '') == 'out' ? 'berkurang' : 'diatur (adjust)')); ?> 
                                         <span class="fw-800 <?php echo e(($activity->type ?? '') == 'in' ? 'text-success' : (($activity->type ?? '') == 'out' ? 'text-primary' : 'text-warning')); ?> fs-6"><?php echo e(abs($activity->quantity_change ?? 0)); ?></span> unit.
                                    </p>
                                    <div class="d-flex align-items-center gap-1 text-muted" style="font-size: 0.7rem; font-weight: 600;">
                                        <div class="avatar-small rounded-circle bg-secondary text-white d-flex align-items-center justify-content-center fw-bold" style="width: 18px; height: 18px; font-size: 0.5rem;">
                                            <?php echo e(strtoupper(substr($activity->user_name ?? 'U', 0, 1))); ?>

                                        </div>
                                        <?php echo e($activity->user_name ?? 'System'); ?>
                ...
                <div class="p-3 mt-auto text-center border-top border-secondary border-opacity-10">
                    <a href="<?php echo e(route('inventories.logs')); ?>" class="btn btn-sm btn-light rounded-pill px-4 fw-bold shadow-sm">
        ...
        <div class="col-12">
            <div class="glass-panel p-0">
                <div class="p-4 d-flex justify-content-between align-items-center border-bottom border-secondary border-opacity-10">
                    ...
                    <a href="<?php echo e(route('inbound.create')); ?>" class="btn btn-premium rounded-pill px-4"><i class="bi bi-plus-lg me-2"></i> Buat PO Baru</a>
                </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <div class="fw-800 text-dark" style="font-size: 0.95rem;"><?php echo e($item->product->name); ?></div>
                                            <div class="text-muted small fw-bold" style="letter-spacing: 0.05em;"><?php echo e($item->product->sku); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <span class="badge bg-secondary bg-opacity-10 text-dark px-3 py-2 rounded-pill fw-bold border"><?php echo e($item->warehouse->name ?? 'Gudang Pusat'); ?></span>
                                </td>
                                ...
                                <td class="text-center text-muted fw-bold"><?php echo e($item->min_quantity); ?></td>
                                <td class="text-end">
                                    <a href="<?php echo e(route('inbound.create', ['product_id' => $item->product_id])); ?>" class="btn btn-sm btn-outline-danger rounded-pill px-4 fw-bold">
                                        Restock
                                    </a>
                                </td>
                            </tr>
...
<script>
    ...
    const warehouses = <?php echo json_encode($warehouses, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity\scratch\easy-pos\resources\views\dashboard_wms.blade.php ENDPATH**/ ?>