...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'E-ASY POS'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Sistem POS Multi-Outlet E-ASY — Kasir, Inventori, Laporan'); ?>">
...
<nav id="sidebar">
    <div class="sidebar-brand">
        <div class="d-flex justify-content-center">
            <img src="<?php echo e(asset('images/logo.png')); ?>" id="semicolon-brand-logo" alt="Logo" style="width: 160px; height: auto; object-fit: contain;">
        </div>
        <small class="d-block text-center mt-2" style="color: #94a3b8; font-size: 0.75rem;"><?php echo e(auth()->user()->outlet?->name ?? 'Pusat Distribusi'); ?></small>
    </div>
    ...
    <div class="sidebar-nav mt-2">
        ...
        <a href="<?php echo e(route('channels.index')); ?>" class="<?php echo e(request()->routeIs('channels.*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('inbound.index')); ?>" id="nav-wms" class="<?php echo e(request()->routeIs('inbound.*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('outbound.index')); ?>" class="<?php echo e(request()->routeIs('outbound.*') ? 'active' : ''); ?>">
            <i class="bi bi-box-arrow-up-right"></i> Outbound (Pick & Pack)
        </a>
        <?php endif; ?>
        <?php if(auth()->user()->hasPermission('view-master-data') || auth()->user()->hasPermission('manage-stock-adjustment') || auth()->user()->isSuperAdmin()): ?>
        <a href="<?php echo e(route('inventories.index')); ?>" class="<?php echo e(request()->routeIs('inventories.index') ? 'active' : ''); ?>">
            <i class="bi bi-archive-fill"></i> Stok Real-time
        </a>
        <a href="<?php echo e(route('stock_transfers.index')); ?>" class="<?php echo e(request()->routeIs('stock_transfers.*') ? 'active' : ''); ?>">
            <i class="bi bi-arrow-left-right"></i> Stock Transfer
        </a>
        <a href="<?php echo e(route('inventories.logs')); ?>" id="nav-audit" class="<?php echo e(request()->routeIs('inventories.logs') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('pos.index')); ?>" id="nav-pos" class="<?php echo e(request()->routeIs('pos.*') ? 'active' : ''); ?>">
            <i class="bi bi-pc-display-horizontal"></i> Kasir / POS Offline
        </a>
        <?php endif; ?>

        <p class="nav-section-label">ERP Core Modules</p>
        <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasRole('supervisor')): ?>
        ...
        <a href="<?php echo e(route('reports.wms')); ?>" class="<?php echo e(request()->routeIs('reports.wms') ? 'active' : ''); ?>">
            <i class="bi bi-bar-chart-steps"></i> Metrik Operasional WMS
        </a>
        <a href="<?php echo e(route('reports.analytics')); ?>" id="nav-report" class="<?php echo e(request()->routeIs('reports.analytics') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('assets.map')); ?>" class="<?php echo e(request()->routeIs('assets.map') ? 'active' : ''); ?>">
            <i class="bi bi-geo-fill"></i> GPS Tracking Asset
        </a>
        <?php endif; ?>

        <?php if(auth()->user()->hasPermission('manage-users') || auth()->user()->hasPermission('manage-master-data') || auth()->user()->isSuperAdmin()): ?>
        <p class="nav-section-label">System & Settings</p>
        <?php if(auth()->user()->hasPermission('manage-master-data')): ?>
        <a href="<?php echo e(route('warehouses.index')); ?>" class="<?php echo e(request()->routeIs('warehouses.*') ? 'active' : ''); ?>">
            <i class="bi bi-building-fill"></i> Manajemen Gudang
        </a>
        <?php endif; ?>
        <?php if(auth()->user()->isSuperAdmin()): ?>
        <a href="<?php echo e(route('outlets.index')); ?>" class="<?php echo e(request()->routeIs('outlets.*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('audit_logs.index')); ?>" class="<?php echo e(request()->routeIs('audit_logs.*') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-user mt-auto">
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="flex-grow-1 overflow-hidden">
                <div class="text-white fw-bold text-truncate" style="font-size:.85rem;"><?php echo e(auth()->user()->name); ?></div>
...
<main id="main">
    <div id="topbar">
        ...
        <div class="ms-auto d-flex align-items-center gap-4">
            ...
            <a href="<?php echo e(route('inventories.index')); ?>" class="btn btn-white border shadow-sm rounded-circle p-0 d-flex align-items-center justify-content-center position-relative" style="width: 40px; height: 40px; border-color: var(--border-color) !important;">
                <i class="bi bi-bell-fill text-primary"></i>
                <?php if(isset($globalLowStockCount) && $globalLowStockCount > 0): ?>
                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: 0.6rem;">
                    <?php echo e($globalLowStockCount); ?>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <span class="fw-bold small d-none d-md-block"><?php echo e(auth()->user()->name); ?></span>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\Admin\.gemini\antigravity\scratch\easy-pos\resources\views\layouts\app.blade.php ENDPATH**/ ?>