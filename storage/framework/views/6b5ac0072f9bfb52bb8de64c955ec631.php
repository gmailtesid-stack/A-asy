...
<div class="stats-grid" style="grid-template-columns: repeat(4, 1fr);">
    ...
    <div class="stat-card" style="border-top: 4px solid var(--primary)">
        ...
        <div class="stat-value">Rp <?php echo e(number_format($data['current_cash'], 0, ',', '.')); ?></div>
    </div>
    
    <!-- Piutang (Akan Masuk) -->
    <div class="stat-card" style="border-top: 4px solid var(--success)">
        <div class="stat-label">Piutang Berjalan (Dari Penjualan Online)</div>
        <div class="stat-value" style="color:var(--success)">+ Rp <?php echo e(number_format($data['accounts_receivable'], 0, ',', '.')); ?></div>
    </div>
    
    <!-- Hutang (Akan Keluar) -->
    <div class="stat-card" style="border-top: 4px solid var(--danger)">
        <div class="stat-label">Hutang Berjalan (Ke Supplier PO)</div>
        <div class="stat-value" style="color:var(--danger)">- Rp <?php echo e(number_format($data['accounts_payable'], 0, ',', '.')); ?></div>
    </div>

    <!-- Proyeksi Kas -->
    <div class="stat-card" style="background: <?php echo e($data['health_status'] == 'healthy' ? 'var(--success)' : 'var(--danger)'); ?>; color:white;">
        <div class="stat-label" style="color:rgba(255,255,255,0.8)">Proyeksi Saldo Kas Mendatang</div>
        <div class="stat-value" style="color:white">Rp <?php echo e(number_format($data['projected_cash'], 0, ',', '.')); ?></div>
    </div>
</div>
...
<div class="card" style="margin-top:2rem;">
    ...
    <div style="padding:2rem;">
        <?php if($data['health_status'] == 'healthy'): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity\scratch\easy-pos\resources\views\reports\cash_flow.blade.php ENDPATH**/ ?>