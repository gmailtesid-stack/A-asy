<?php $__env->startSection('title', 'Dashboard Laporan — E-ASY POS'); ?>
...
<div class="row g-3 mb-4">
    <div class="col-xl-3 col-md-6">
        <div class="kpi-card kpi-blue">
            ...
            <div class="kpi-value">Rp <?php echo e(number_format($summaryStats['today_revenue'], 0, ',', '.')); ?></div>
            <div class="kpi-sub"><?php echo e($summaryStats['today_trx']); ?> transaksi</div>
        </div>
    </div>
    <div class="col-xl-3 col-md-6">
        <div class="kpi-card kpi-green">
            ...
            <div class="kpi-value">Rp <?php echo e(number_format($summaryStats['month_revenue'], 0, ',', '.')); ?></div>
            <div class="kpi-sub"><?php echo e($summaryStats['month_trx']); ?> transaksi</div>
        </div>
    </div>
    <div class="col-xl-3 col-md-6">
        <div class="kpi-card kpi-violet">
            ...
            <div class="kpi-value"><?php echo e(count($outletCompare)); ?></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="kpi-card kpi-orange">
            ...
            <div class="kpi-value"><?php echo e($topProducts[0]->product_name ?? '—'); ?></div>
            <div class="kpi-sub"><?php echo e($topProducts[0]->total_sold ?? 0); ?> unit terjual</div>
        </div>
    </div>
</div>
        ...
        <div class="chart-card">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex gap-2">
                    <a href="<?php echo e(route('reports.export.sales')); ?>" class="btn btn-sm btn-success rounded-pill px-3">
    ...
    <div class="col-xl-5">
        <div class="chart-card h-100">
            ...
            <div class="top-product-row">
                <div class="rank-badge <?php echo e($i === 0 ? 'rank-1' : ($i === 1 ? 'rank-2' : ($i === 2 ? 'rank-3' : 'rank-n'))); ?>">
                    <?php echo e($i + 1); ?>

                </div>
                <div class="flex-1" style="flex:1;">
                    <div style="font-size:.85rem;font-weight:600;"><?php echo e($p->product_name); ?></div>
                    <div style="font-size:.75rem;color:#64748b;"><?php echo e($p->category); ?></div>
                </div>
                <div class="text-end">
                    <div style="font-size:.85rem;font-weight:700;color:#2563eb;"><?php echo e($p->total_sold); ?> unit</div>
                    <div style="font-size:.72rem;color:#64748b;">Rp <?php echo e(number_format($p->total_revenue, 0, ',', '.')); ?></div>
                </div>
            </div>
...
const outletData  = <?php echo json_encode($outletCompare, 15, 512) ?>;
const topProducts = <?php echo json_encode($topProducts, 15, 512) ?>;
...
async function refreshCharts() {
    try {
        const res  = await fetch('<?php echo e(route("reports.live")); ?>');
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity\scratch\easy-pos\resources\views\reports\dashboard.blade.php ENDPATH**/ ?>