<?php $__env->startSection('title', 'GPS Real-time Asset Map - E-ASY POS'); ?>
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            <div class="badge bg-primary-subtle text-primary rounded-pill px-3 py-2 fw-bold">
                <i class="bi bi-geo-alt-fill me-1"></i> <?php echo e(count($outlets)); ?> Outlets
            </div>
            <div class="badge bg-success-subtle text-success rounded-pill px-3 py-2 fw-bold">
                <i class="bi bi-building-fill me-1"></i> <?php echo e(count($warehouses)); ?> Warehouses
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity\scratch\easy-pos\resources\views\reports\asset_map.blade.php ENDPATH**/ ?>