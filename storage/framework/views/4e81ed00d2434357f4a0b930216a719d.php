<?php $__env->startSection('title', 'Buat Sales Order Baru - E-ASY WMS'); ?>

<?php $__env->startSection('content'); ?>
<div class="animate__animated animate__fadeIn">
    <div class="mb-4">
        <a href="<?php echo e(route('outbound.index')); ?>" class="text-decoration-none small text-muted">
            <i class="bi bi-arrow-left me-1"></i> Kembali ke Daftar Outbound
        </a>
        <h2 class="fw-bold mt-2">Buat Sales Order (SO)</h2>
    </div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-0">
                            <label class="form-label small fw-bold text-muted">Gudang Asal</label>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mt-4 pt-4 border-top text-end">
                            <button type="submit" class="btn btn-primary rounded-pill px-5">
                                Simpan Sales Order <i class="bi bi-check2-circle ms-2"></i>
                            </button>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity\scratch\easy-pos\resources\views\outbound\create.blade.php ENDPATH**/ ?>