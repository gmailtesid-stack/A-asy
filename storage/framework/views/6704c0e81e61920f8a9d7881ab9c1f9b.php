<?php $__env->startSection('title', 'Manajemen Supplier - E-ASY WMS'); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('master.index')); ?>" class="text-decoration-none">Master Data</a></li>
                    ...
                    <tbody class="border-top-0">
                        ...
                        <tr class="bg-white border-bottom transition-all">
                            <td class="ps-4">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <span class="fw-800 text-dark"><?php echo e($supplier->name); ?></span>
                                </div>
                            </td>
                            <td class="text-muted"><?php echo e($supplier->contact_person ?? '-'); ?></td>
                            <td>
                                <div class="d-flex flex-column">
                                    <?php if($supplier->email): ?>
                                    <span class="text-muted small"><i class="bi bi-envelope me-1"></i> <?php echo e($supplier->email); ?></span>
                                    <?php endif; ?>
                                    <?php if($supplier->phone): ?>
                                    <span class="text-muted small"><i class="bi bi-telephone me-1"></i> <?php echo e($supplier->phone); ?></span>
                                    <?php endif; ?>
                            ...
                            <td class="text-muted text-truncate" style="max-width: 200px;" title="<?php echo e($supplier->address); ?>">
                            ...
                            <td class="text-end pe-4">
                                <div class="d-flex justify-content-end gap-2">
                                    <?php if(auth()->user()->hasPermission('manage-master-data')): ?>
                                    <button class="btn btn-sm btn-light border rounded-circle" style="width: 32px; height: 32px;" data-bs-toggle="modal" data-bs-target="#editSupplierModal<?php echo e($supplier->id); ?>">
                        ...
                        <div class="modal fade" id="editSupplierModal<?php echo e($supplier->id); ?>" tabindex="-1">
                            <div class="modal-dialog">
                                <form action="<?php echo e(route('suppliers.update', $supplier)); ?>" method="POST" class="modal-content border-0 shadow">
...
<div class="modal fade" id="addSupplierModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="<?php echo e(route('suppliers.store')); ?>" method="POST" class="modal-content border-0 shadow">
            <?php echo csrf_field(); ?>
            <div class="modal-header border-0 pb-0">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity\scratch\easy-pos\resources\views\master\suppliers\index.blade.php ENDPATH**/ ?>