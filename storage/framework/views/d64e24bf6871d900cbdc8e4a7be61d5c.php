<?php $__env->startSection('title', 'Kasir — E-ASY POS'); ?>
    ...
    <div class="product-section">
        ...
        <div class="product-grid" id="productGrid">
            ...
            <div class="product-card"
                 ...
                 data-stock="<?php echo e($product->inventories->where('outlet_id', auth()->user()->outlet_id)->first()?->quantity ?? 0); ?>"
                 data-image="<?php echo e($product->image_url); ?>"
                 onclick="addToCart(this)">
                <img src="<?php echo e($product->image_url); ?>" alt="<?php echo e($product->name); ?>" onerror="this.src='https://placehold.co/100x100?text=IMG'">
                <div class="p-name"><?php echo e($product->name); ?></div>
                <div class="p-price">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></div>
                <div class="p-stock">Stok: <?php echo e($product->inventories->where('outlet_id', auth()->user()->outlet_id)->first()?->quantity ?? 0); ?></div>
            </div>
        ...
        <div class="recent-bar shadow-sm">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-sm align-middle mb-0" style="font-size: .85rem;">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="recent-item">
                            <td class="fw-bold"><?php echo e($rt->invoice_number); ?></td>
                            <td><?php echo e($rt->cashier->name); ?></td>
                            <td class="fw-bold text-primary">Rp <?php echo e(number_format($rt->total, 0, ',', '.')); ?></td>
                            <td class="text-end">
                                <a href="<?php echo e(route('pos.receipt', $rt)); ?>" target="_blank" class="btn btn-sm btn-light rounded-pill">
        ...
        <div class="cart-header">
            ...
            <div class="customer-selector position-relative">
                ...
                <select id="customerId" class="form-select border-0 shadow-none ps-5 py-2 rounded-3 small" style="background: var(--card-bg); font-size: .85rem;">
                    ...
                    <option value="<?php echo e($customer->id); ?>"><?php echo e($customer->name); ?> (<?php echo e(number_format($customer->loyalty_points)); ?> pts)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity\scratch\easy-pos\resources\views\pos\index.blade.php ENDPATH**/ ?>