<?php $__env->startSection('title', 'Stock Transfer - E-ASY WMS'); ?>
...
<div class="animate__animated animate__fadeIn">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('stock_transfers.create')); ?>" class="btn btn-primary shadow-sm px-4 fw-bold">
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <table class="table table-hover align-middle mb-0" style="font-size: 0.85rem;">
                    ...
                    <tbody class="border-top-0">
                        ...
                        <tr class="bg-white border-bottom">
                            <td class="ps-4 py-3">
                                <div class="fw-bold text-primary" style="font-size: 0.95rem;"><?php echo e($transfer->transfer_number); ?></div>
                                <div class="text-muted small"><?php echo e($transfer->created_at->format('d/m/Y H:i')); ?></div>
                            </td>
                            <td>
                                <div class="fw-bold text-dark mb-0"><?php echo e($transfer->fromWarehouse->name); ?></div>
                                <span class="text-muted small">ID: #WH-<?php echo e($transfer->from_warehouse_id); ?></span>
                            </td>
                            <td>
                                <div class="fw-bold text-dark mb-0"><?php echo e($transfer->toWarehouse->name); ?></div>
                                <span class="text-muted small">ID: #WH-<?php echo e($transfer->to_warehouse_id); ?></span>
                            </td>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-xs bg-secondary rounded-circle text-white d-flex align-items-center justify-content-center" style="width: 24px; height: 24px; font-size: 0.6rem;">
                                        <?php echo e(strtoupper(substr($transfer->user->name, 0, 1))); ?>

                                    </div>
                                    <span class="text-dark"><?php echo e($transfer->user->name); ?></span>
                                </div>
                            </td>
                            <td class="text-center">
                                ...
                                <span class="badge bg-<?php echo e($statusConfig['color']); ?>-subtle text-<?php echo e($statusConfig['color']); ?> border border-<?php echo e($statusConfig['color']); ?>-subtle rounded-pill px-3 py-2 fw-bold">
                                    <i class="bi <?php echo e($statusConfig['icon']); ?> me-1"></i> <?php echo e(strtoupper($transfer->status)); ?>

                                </span>
                            </td>
                            <td class="text-end pe-4">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="<?php echo e(route('stock_transfers.show', $transfer)); ?>" class="btn btn-sm btn-light border px-3 rounded-pill">Detail</a>
                                    
                                    <?php if($transfer->status == 'pending'): ?>
                                    <form action="<?php echo e(route('stock_transfers.ship', $transfer)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                        <button class="btn btn-sm btn-primary rounded-pill px-3 shadow-sm fw-bold border-0">Kirim (Ship)</button>
                                    </form>
                                    <?php endif; ?>

                                    <?php if($transfer->status == 'transit'): ?>
                                    <form action="<?php echo e(route('stock_transfers.receive', $transfer)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="card-footer bg-white py-3 border-top d-flex justify-content-between align-items-center">
            <span class="text-muted small">Menampilkan <?php echo e($transfers->firstItem()); ?> - <?php echo e($transfers->lastItem()); ?> dari <?php echo e($transfers->total()); ?> transfer</span>
            <?php echo e($transfers->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity\scratch\easy-pos\resources\views\stock_transfers\index.blade.php ENDPATH**/ ?>