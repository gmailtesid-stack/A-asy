<?php $__env->startSection('title', 'Buat Transfer Stok - E-ASY WMS'); ?>
...
<div class="animate__animated animate__fadeIn">
    <form action="<?php echo e(route('stock_transfers.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('stock_transfers.index')); ?>" class="btn btn-light border px-4 rounded-3">Batal</a>
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="from_warehouse_id" class="form-select border-0 bg-light rounded-3 fw-bold <?php $__errorArgs = ['from_warehouse_id'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="to_warehouse_id" class="form-select border-0 bg-light rounded-3 fw-bold <?php $__errorArgs = ['to_warehouse_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity\scratch\easy-pos\resources\views\stock_transfers\create.blade.php ENDPATH**/ ?>