<?php $__env->startSection('title', 'Edit SKU Katalog - E-ASY OMS'); ?>
...
<div class="animate__animated animate__fadeIn">
    <form action="<?php echo e(route('products.update', $product)); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="h4 mb-1 fw-800 text-dark">Edit Produk: <?php echo e($product->name); ?></h2>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name', $product->name)); ?>" required placeholder="Masukkan nama produk lengkap...">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('csku', $product->csku)); ?>" placeholder="Opsional (Default = ISKU)">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" class="form-control bg-light border-0 rounded-3" rows="4" placeholder="Jelaskan detail produk..."><?php echo e(old('description', $product->description)); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('cost_price', $product->cost_price)); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('unit', $product->unit)); ?>" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm mb-4 rounded-4">
                    <div class="card-body p-4">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <img src="<?php echo e($product->image_url); ?>" alt="" class="rounded-4 border shadow-sm" style="width: 120px; height: 120px; object-fit: cover;">
                            </div>
                            <?php endif; ?>
                            <div class="col">
                                <div class="border-2 border-dashed border-secondary border-opacity-25 rounded-4 p-4 text-center bg-light">
                                    ...
                                    <input type="file" name="image" class="form-control mt-2 bg-white border-0 <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                ...
                <div class="card border-0 shadow-sm mb-4 rounded-4 overflow-hidden">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            ?>
                            <select name="status" class="form-select border-0 bg-light rounded-3 fw-bold <?php echo e($statusColors[$product->status] ?? 'text-muted'); ?>">
                                <option value="live" <?php echo e(old('status', $product->status) === 'live' ? 'selected' : ''); ?> class="text-success">● LIVE</option>
                                <option value="draft" <?php echo e(old('status', $product->status) === 'draft' ? 'selected' : ''); ?> class="text-secondary">● DRAFT</option>
                                <option value="under_review" <?php echo e(old('status', $product->status) === 'under_review' ? 'selected' : ''); ?> class="text-warning">● UNDER REVIEW</option>
                                <option value="failed" <?php echo e(old('status', $product->status) === 'failed' ? 'selected' : ''); ?> class="text-danger">● FAILED</option>
                            </select>
                        ...
                        <div class="mb-0">
                            ...
                            <select name="type" class="form-select border-0 bg-light rounded-3">
                                <option value="simple" <?php echo e(old('type', $product->type) === 'simple' ? 'selected' : ''); ?>>Simple Product</option>
                                <option value="variant" <?php echo e(old('type', $product->type) === 'variant' ? 'selected' : ''); ?>>Variant Product</option>
                                <option value="kit" <?php echo e(old('type', $product->type) === 'kit' ? 'selected' : ''); ?>>Product Kit / Bundle</option>
                            </select>
                        </div>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" required>
                ...
                <div class="card border-0 shadow-sm mb-4 rounded-4 bg-primary bg-opacity-10">
                    <div class="card-body p-4">
                        ...
                        <h3 class="fw-800 mb-0"><?php echo e($product->inventories()->sum('quantity')); ?> <span class="fs-6 fw-normal text-muted"><?php echo e($product->unit); ?></span></h3>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity\scratch\easy-pos\resources\views\products\edit.blade.php ENDPATH**/ ?>