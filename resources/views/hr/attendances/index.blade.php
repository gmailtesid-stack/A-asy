            ...
            <div class="table-responsive">
                <table class="table table-dark-custom mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="fw-bold">{{ $attendance->date }}</td>
                            <td>
                            ...
                            <td class="text-success fw-bold">{{ $attendance->clock_in ?? '--:--' }}</td>
                            <td class="text-danger fw-bold">{{ $attendance->clock_out ?? '--:--' }}</td>
                            <td>
                                <span class="badge bg-{{ $attendance->status == 'present' ? 'success' : 'warning' }}-soft">
                                    {{ strtoupper($attendance->status) }}
                                </span>
                            </td>
                            <td class="text-white-50 small">{{ $attendance->notes ?? '-' }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
