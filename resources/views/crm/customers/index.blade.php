...
<div class="container-fluid py-4">
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-md-6 text-end">
            <a href="{{ route('customers.create') }}" class="btn btn-danger text-white px-4 rounded-pill shadow-lg">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="small text-white-50">ID: CUST-{{ str_pad($customer->id, 4, '0', STR_PAD_LEFT) }}</div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="small text-white"><i class="fas fa-phone me-2 text-white-50"></i>{{ $customer->phone ?? '-' }}</div>
                                <div class="small text-white-50"><i class="fas fa-envelope me-2 text-white-50"></i>{{ $customer->email ?? '-' }}</div>
                            </td>
                            <td>{{ $customer->outlet->name ?? 'Pusat' }}</td>
                            <td class="text-center">
                                <div class="d-inline-flex align-items-center bg-danger-soft text-danger px-3 py-1 rounded-pill fw-bold">
                                    <i class="fas fa-star me-2"></i>{{ number_format($customer->loyalty_points, 0) }}
                                </div>
                            </td>
                            <td class="text-end">
