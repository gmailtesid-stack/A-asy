        ...
        <div class="col-md-4">
            <div class="card bg-glass border-0 shadow-lg">
                <div class="card-body p-4 text-center">
                    ...
                    <h3 class="fw-bold text-white">Rp {{ number_format($cashBalance, 0, ',', '.') }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-lg-8">
            <div class="card bg-glass border-0 shadow-lg h-100">
                <div class="card-header bg-transparent border-bottom border-white-10 p-4 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('finance.journals') }}" class="btn btn-sm btn-outline-light rounded-pill px-3">Lihat Semua</a>
                </div>
                        ...
                        <table class="table table-hover table-dark-custom mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-primary-soft text-primary">{{ $journal->reference }}</span></td>
                                    <td>{{ $journal->description }}</td>
                                    <td class="text-end fw-bold">Rp {{ number_format($journal->lines->sum('debit'), 0, ',', '.') }}</td>
                                </tr>
                                @empty
                                <tr>
            ...
            <div class="card bg-glass border-0 shadow-lg h-100">
                ...
                <div class="card-body p-4">
                    <div class="d-grid gap-3">
                        <a href="{{ route('finance.reports.profit-loss') }}" class="btn btn-primary-glass p-3 text-start d-flex align-items-center">
                        ...
                        <a href="{{ route('finance.accounts') }}" class="btn btn-info-glass p-3 text-start d-flex align-items-center">
