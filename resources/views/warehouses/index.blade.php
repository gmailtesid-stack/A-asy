                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div class="brand-logo bg-primary bg-opacity-10 text-primary overflow-hidden" style="width: 50px; height: 50px; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                            @if($warehouse->photo)
                            <img src="{{ $warehouse->photo }}" alt="Warehouse Photo" style="width: 100%; height: 100%; object-fit: cover;">
                            @else
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button class="btn btn-sm btn-light rounded-pill" data-bs-toggle="modal" data-bs-target="#editWarehouseModal{{ $warehouse->id }}">
                        ...
                        <div class="modal-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="outlet_id" class="form-select rounded-3" required>
                                    ...
                                    <option value="{{ $outlet->id }}" {{ $warehouse->outlet_id == $outlet->id ? 'selected' : '' }}>{{ $outlet->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="latitude" class="form-control rounded-3" value="{{ $warehouse->latitude }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-semibold small text-primary"><i class="bi bi-geo-alt me-1"></i> Longitude</label>
                                    <input type="text" name="longitude" class="form-control rounded-3" value="{{ $warehouse->longitude }}">
                                </div>
                            </div>
                        </div>
